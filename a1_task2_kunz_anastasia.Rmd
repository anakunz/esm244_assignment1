...
```{r, fig.cap = "**Figure 1.** PCA biplot shows the relationship between 8 different climatic and environmental variables for 188 countries utilizing data from @zander_venter on Kaggle."}
